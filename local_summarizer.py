...
class LocalSummarizer:
    """
    Thin wrapper over a seq2seq model (default: t5-small) for fast local summaries.
    """
    def __init__(
        self,
        ...
        self.model.eval()
    def summarize(self, text: str, prefix: str = "summarize: ") -> str:
        if not text.strip():
            return ""
...
if __name__ == "__main__":
    import sys
    sample_text = " ".join(sys.argv[1:]) or "Mindstream listens to speech, finds the dominant theme, and steers Livepeer Daydream visuals accordingly."
    summarizer = LocalSummarizer()
